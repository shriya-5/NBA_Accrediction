...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $tot=$q1+$q2+$q3+$q4+$q5+$q6+$q7+$q8;
      ...
      $sql="insert into assess2mark values('$id','$course','$n','$q1','$q2','$q3','$q4','$q5','$q6','$q7','$q8','$tot');";
      ...
      $sql11="Select * from assess2 where staff_id='$id' and course_code='$course'";
...
$sql12="insert into assess2co values('$id','$course','$n','$sum_co1','$sum_co2','$sum_co3','$sum_co4','$sum_co5','$sum_co6');";
...
<br>
<div class="heading">ASSESSMENT 2 MARKS</div>
        <br><br>
