...
ASSESSMENT 2 CO CALCULATION</div>
...
{
$course=$_POST['course'];
$sql = "select * from assess2co where course_code='$course' and staff_id='$id'";
$res = mysqli_query($conn,$sql);
$a= mysqli_num_rows($res);

$sql1="select round(AVG(CO1),2) AS co1_avg FROM assess2co";
$result = mysqli_query($conn, $sql1); 
$row1 = mysqli_fetch_assoc($result); 
$co1avg = $row1['co1_avg'];

$sql2="select round(AVG(CO2),2) AS co2_avg FROM assess2co";
$result2 = mysqli_query($conn, $sql2); 
$row2 = mysqli_fetch_assoc($result2); 
$co2avg = $row2['co2_avg'];

$sql3="select round(AVG(CO3),2) AS co3_avg FROM assess2co";
$result3 = mysqli_query($conn, $sql3); 
$row3 = mysqli_fetch_assoc($result3); 
$co3avg = $row3['co3_avg'];

$sql4="select round(AVG(CO4),2) AS co4_avg FROM assess2co";
$result4 = mysqli_query($conn, $sql4); 
$row4 = mysqli_fetch_assoc($result4); 
$co4avg = $row4['co4_avg'];

$sql5="select round(AVG(CO5),2) AS co5_avg FROM assess2co";
$result5 = mysqli_query($conn, $sql5); 
$row5 = mysqli_fetch_assoc($result5); 
$co5avg = $row5['co5_avg'];

$sql6="select round(AVG(CO6),2) AS co6_avg FROM assess2co";
