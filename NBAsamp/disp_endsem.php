...
{
$course=$_POST['course'];
$sql = "select * from endsem_mark where course_code='$course' and staff_id='$id'";
...
if($a>0)
{
    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        <td>".$row['Q1']."</td><td>".$row['Q2']."</td><td>".$row['Q3']."</td><td>".$row['Q4']."</td><td>".$row['Q5']."</td><td>".$row['Q6']."</td><td>".$row['Q7']."</td><td>".$row['Q8']."</td><td>".$row['Q9']."</td><td>".$row['Q10']."</td><td>".$row['Q11']."</td><td>".$row['Q12']."</td><td>".$row['Q13']."</td><td>".$row['Q14']."</td><td>".$row['Q15']."</td><td>".$row['Q16']."</td><td>".$row['total_mark']."</td></tr>";       
    }
    echo "</table>";
